<x-app-layout>
    <div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        ...
        <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
            <img class="w-full" alt="image of a girl posing" src="https://www.flokq.com/blog/wp-content/uploads/2021/10/menarabca-494x600.png" />
            <div class="flex flex-row">
                <img class="mt-6 w-1/4" alt="image of a girl posing" src="https://images.unsplash.com/photo-1631469171215-247271da1c20?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"/>
                <div class="ml-10"></div>
                <img class="mt-6 w-1/4" alt="image of a girl posing" src="https://images.unsplash.com/photo-1632669744768-79d6b5087691?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"/>
                <div class="ml-10"></div>
                <img class="mt-6 w-1/4" alt="image of a girl posing" src="https://images.unsplash.com/photo-1576688453917-33e511b2e82d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80"/>
            </div>
        ...
        <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
            ...
            <p class="text-sm leading-none text-gray-600 dark:text-gray-300 ">Jakarta's best Tower</p>
            <h1 class="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-800 dark:text-white mt-2">Central Asia Bank Tower</h1>
            </div>
            <div class="py-4 border-b border-gray-200 flex items-center justify-between">
            <p class="text-base leading-4 text-gray-800 dark:text-gray-300">Address</p>
            <div class="flex items-center justify-center">
                <p class="text-sm leading-none text-gray-600 dark:text-gray-300">Jl. M.H. Thamrin, 10230, DKI Jakarta</p>
            </div>
            </div>
            <div class="py-4 border-b border-gray-200 flex items-center justify-between">
            <p class="text-base leading-4 text-gray-800 dark:text-gray-300">Area</p>
            <div class="flex items-center justify-center">
                <p class="text-sm leading-none text-gray-600 dark:text-gray-300 mr-3">82.000m²</p>
            ...
            <div class="w-full">
                <p class="text-base lg:leading-tight leading-normal text-gray-600 dark:text-gray-300 mt-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam magni recusandae, exercitationem ex dolorum ullam nisi! Animi nesciunt et voluptatem, cum corporis incidunt voluptatum nostrum error magnam praesentium iure harum?</p>
                <p class="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">Developer: PT. Grand Indonesia</p>
                <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Floor Level : 56 Floors</p>
                <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Property Purpose : Offices</p>
                <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Area per Level: 1464.29 m2</p>
                <p class="md:w-96 text-base leading-normal text-gray-600 dark:text-gray-300 mt-4">Type: Lease Only</p>
            </div>
