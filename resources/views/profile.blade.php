        ...
        <div class="bg-gray-200 min-h-screen pt-2 my-16">
            <div class="container mx-auto">
                <div class="inputs w-full max-w-2xl p-6 mx-auto">
                    ...
                    <form action="{{ route('tenant.profile.update') }}" class="mt-6 border-t border-gray-400 pt-4"
                            ...
                            <div class="personal w-full border-t border-gray-400 pt-4">
                                    ...
                                    <div class='w-full md:w-1/2 px-3 mb-6'>
                                        ...
                                        <div class="flex-shrink w-full inline-block relative">
                                            <select
                                                ...
                                                id="gender" name="gender" require>
                                                <option {{ $profile->gender == 'Man' ? 'selected' : '' }}>Man</option>
                                                <option {{ $profile->gender == 'Woman' ? 'selected' : '' }}>Woman
                                                </option>
                                            </select>
                                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div class='w-full md:w-1/2 px-3 mb-6'>
                                        ...
                                        <input
                                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                                            type='text' id="phone" name="phone" value="{{ $profile->phone }}"
                                            required>
                                    </div>
                                    <div class='w-full md:w-1/2 px-3 mb-6'>
                                        <label
                                            class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Birthday
                                            Date</label>
                                        <input
                                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                                            id='date' name="date" type='date' placeholder='Enter birthday date'
                                ...
                                <div class='w-full md:w-full px-3 mb-6'>
                                    ...
                                    <input
                                        class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                                        id='grid-text-1' type='text' id='city' name="city" placeholder='Enter city'
